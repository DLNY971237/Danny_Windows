...
class Window(ThemedTk):
    ...
    def click1(self):
        ...
        message = "\n".join(message_data)
        print(message)
        ShowInfo(parent=self,title="全台aqi最佳前五個區域",message=message)      
    ...
    def click2(self):
        ...
        message = "\n".join(message_data)
        print(message)
        ShowInfo(parent=self,title="全台aqi最差五個區域",message=message)    
    ...
    def click3(self):
        ...
        message = "\n".join(message_data)
        print(message)
        ShowInfo(parent=self,title="全台pm2.5最佳前五個區域",message=message)    
    ...
    def click4(self):        
        ...
        message = "\n".join(message_data)
        print(message)
        ShowInfo(parent=self,title="全台pm2.5最差五個區域",message=message)
...
class ShowInfo(Dialog):
    ...
    def body(self, master: Frame) -> Misc | None:
        text = tk.Text(self,height=8,font=('Helvetica',12),width=60)
